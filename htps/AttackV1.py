...
class AttackV1:
    ...
    def get_transformations(self, current_text, original_text=None, **kwargs):
        ...
        return self.filter_transformations(
            transformed_texts, current_text, original_text, **kwargs
        )

    def _filter_transformations_uncached(
        self, transformed_texts, current_text, original_text=None, **kwargs
    ):
        ...
        for C in self.constraints:
            ...
            if C.compare_against_original:
                ...
                if not isinstance(C, UniversalSentenceEncoder):
                    filtered_texts = C.call_many(filtered_texts, original_text, **kwargs)
                else:
    ...
    def filter_transformations(
        ...
        filtered_texts += self._filter_transformations_uncached(
            uncached_texts, current_text, original_text=original_text, **kwargs
        )
