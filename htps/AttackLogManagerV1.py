...
from textattack.loggers import FileLogger, VisdomLogger, WeightsAndBiasesLogger
from textattack.shared import AttackedText

from htps.CSVLoggerV1 import CSVLoggerV1

class AttackLogManagerV1:
    ...
    def add_output_csv(self, filename, color_method):
        self.loggers.append(CSVLoggerV1(filename=filename, color_method=color_method))
    ...
    def log_summary(self):
        ...
        for i, result in enumerate(self.results):
            ...
            # num_words_changed = result.original_result.attacked_text.all_words_diff(
            #     result.perturbed_result.attacked_text
            # )
            num_words_changed = result.perturbed_result.attacked_text.attack_attrs["perturbed_num"]
