...
def transformation_consists_of_word_swaps(transformation):
    ...
    return transformation_consists_of(transformation, [WordSwap, WordSwapGradientBased, WordSwapV1])


def transformation_consists_of_word_swaps_and_insertions(transformation):
    from textattack.transformations import WordSwap, WordSwapGradientBased

    return transformation_consists_of(transformation, [WordSwap, WordSwapGradientBased, WordSwapV1, WordInsertionV1])
...
def transformation_consists_of_word_swaps_and_deletions(transformation):
    ...
    return transformation_consists_of(
        transformation, [WordDeletion, WordSwap, WordSwapGradientBased, WordSwapV1]
    )


def transformation_consists_of_word_insertions(transformation):
    return transformation_consists_of(
        transformation, [WordInsertionV1]
    )