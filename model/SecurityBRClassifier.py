...
class SecurityClassifier():
    ...
    def evaluate_b(self, y, y_pred):
        ...
        result=[TN,TP,FN,FP,pd,pf,prec,f_measure,g_measure,accuracy]
    ...
    def lr_cross_validation(self, train_x, train_y):
        ...
        param_grid = [{'penalty':['l1','l2'], 'C':[0.01,0.05,0.1,0.5,1,5,10,50,100],'solver':['liblinear'],'multi_class':['ovr'],'class_weight':['balanced',None]},
    ...
    def Blend_Classifier(self, train_x, train_y):
        from StackedGeneralizer import StackedGeneralizer
        ...
        N_FOLDS = 5
        # define base models
        base_models = [KNeighborsClassifier(),
                       MLPClassifier(hidden_layer_sizes=(30, 30, 30), activation='tanh', max_iter=300),
                       GaussianNB()]
